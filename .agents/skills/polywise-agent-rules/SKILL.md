...
3. Before creating files, refactoring modules, or writing core logic, read the target package's outline-level `unify.md` and follow the matched route's sample paths.
