					...
					include: [
						{
							...
							build_command: [
								...
								'pnpm --dir packages/desktop exec cross-env BUILD_ARCH=x64 pnpm --dir packages/desktop run rebuild',
								retry_command,
						...
						},
						{
							...
							build_command: [
								desktop_shared_build_command,
								'pnpm --dir packages/desktop exec cross-env BUILD_ARCH=arm64 pnpm --dir packages/desktop run rebuild',
								retry_command,
