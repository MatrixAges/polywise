...
- 🐘 **[Sqlite](https://github.com/sqlite/sqlite)** - 全球部署量最多的高性能端侧数据库
- 🏹 **[sqlite-vec](https://github.com/asg017/sqlite-vec)** - 为 Sqlite 提供向量搜索支持
...
- 🤗 **[node-llama-cpp](https://github.com/withcatai/node-llama-cpp)** - llama-cpp 的 nodejs 绑定，用于对接本地模型
