      ...
      <InputGroupAddon className={$cx("py-0!",ghost&&"pr-0!")} align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className={$cx("h-8! group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent hover:bg-transparent",ghost&&"w-auto! ml-0.5")}
            disabled={disabled}
          />
        )}
