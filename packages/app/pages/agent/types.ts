...
export type AgentGraphResponse = RPCOutput['agent']['getGraph']
export type AgentGraphNode = AgentGraphResponse['nodes'][number]
export type AgentGraphEdge = AgentGraphResponse['edges'][number]
export type AgentGraphSelectedNode = NonNullable<AgentGraphResponse['selected_node']>
