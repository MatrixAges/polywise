	...
	return {
		tool: {
			tool: {
				polywise: tool({
					description: `
                              Manage the polywise persist memory:
                              - Use 'query' to find relevant memories
                              - Use 'save' to save new memory
                              - Use 'update' to update exist memory by memory_id
                              - Use 'forget' to forget memory by memory_id
                              - 'query' is the user query
                              - 'content' is the content should be saved as memory
                              - 'memory_id' is the update and forget action's parameter
                              `,
					args: {
						action: tool.schema.enum(['query', 'save', 'update', 'forget']),
