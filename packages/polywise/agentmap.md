		...
		"src": {
			...
			"fst": {
				...
				"tools": {
					...
					"title.ts": "Internal tool that generates and updates session titles while protecting manually edited titles; when title changes it emits {id,title} through rpc/session/watchSessionTitle emitter for frontend realtime menu sync",
