	...
	"structure": {
		"src": {
			...
			"utils": {
				...
				"generateId.ts": { "desc": "Unique string ID generator using nanoid", "role": "Utility" },
...
- **Unique String IDs**: ALL IDs (node_id, article_id, edge_id, memory_id) are TEXT strings generated by nanoid, NOT auto-incrementing integers
