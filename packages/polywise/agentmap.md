		...
		"src": {
			...
			"db": {
				...
				"schema": {
					...
					"session.ts": {
						"desc": "Chat session storage schema with nullable key, optional im/cron flags, running_since start timestamp, running_done end timestamp, and related indexes",
						"role": "Schema"
					},
					"project.ts": {
