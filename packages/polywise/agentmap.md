		...
		"src": {
			...
			"fst": {
				...
				"tools": {
					...
					"report.ts": "Internal tool that updates the short session report summary for todo-linked sessions, now capped at 48 characters and guided to reflect user-visible progress during longer work with a mandatory final completed-style refresh before user-facing delivery",
