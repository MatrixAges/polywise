...
export const sql_add_node = `
  INSERT INTO ${app.db.schema_brain}.nodes (id, label, x, y, threshold, current_threshold, transmitter, embedding, article_ids, lock, is_active)
...
export const sql_upsert_node = `
  INSERT INTO ${app.db.schema_brain}.nodes (id, label, x, y, potential, threshold, current_threshold, transmitter, embedding, article_ids, lock, is_active)
  VALUES ($1, $2, random() * 800, random() * 600, 1.0, ${system.shy.min_threshold}, ${system.shy.min_threshold}, 1.0, $3, $4, $5, FALSE)
