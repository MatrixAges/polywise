import Calendar from 'antd/es/calendar/locale/es_ES'
import DatePicker from 'antd/es/date-picker/locale/es_ES'
import TimePicker from 'antd/es/time-picker/locale/es_ES'
