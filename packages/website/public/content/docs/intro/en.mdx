...
Or download the desktop application from [GitHub Releases](https://github.com/MatrixAges/polywise/releases).
...
<Steps>
  ...
  <Step title="Download local models or configure cloud embedding and rerank">
  ...
  <Step title="Start a chat and verify the provider">
