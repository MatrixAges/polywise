...
function e(t, e, i) {
	return ((e = a(e)), u(t, h() ? Reflect.construct(e, i || [], a(t).constructor) : e.apply(t, i)))
}
function i(t, e) {
...
function k(t, e, i) {
	var r = e[0],
		...
		o = i[1],
		h = i[2]
	return ((t[0] = n * h - s * o), (t[1] = s * a - r * h), (t[2] = r * o - n * a), t)
}
var M,
	A,
	T =
			...
			[
				...
				},
				{
					...
					value: function (t) {
						...
						var a = 2
						;((null === (e = this.attributes.index) || void 0 === e ? void 0 : e.type) ===
							this.gl.UNSIGNED_INT && (a = 4),
							this.isInstanced
								? this.attributes.index
				...
				},
				{
					...
					value: function () {
						...
						for (var e in this.attributes)
							(this.gl.deleteBuffer(this.attributes[e].buffer), delete this.attributes[e])
					}
				}
			]
		)
					...
					value: function (t) {
						...
						if (
							...
							for (
								...
								;-1 !== c && ((o[c] = l.name), this.attributeLocations.set(l, c))
							}
				...
				},
				{
					...
					value: function (t) {
						...
						;(null === n
							...
							this.getRenderList({ scene: e, camera: i, frustumCull: l, sort: h }).forEach(
								function (t) {
									t.draw({ camera: i })
								}
							))
...
var X = function (t, e) {
	...
	Y = (function (t) {
		function r() {
			...
			;(i(this, r), ((t = e(this, r, [n, s, a, o])).onChange = function () {}), (t._target = t))
			var h = ['0', '1', '2', '3']
			return u(
				t,
				new Proxy(t, {
		...
		return (
			...
			n(r, [
				...
				},
				{
					...
					value: function () {
						var t =
							arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._target
						return (
							(function (t, e) {
								var i = e[0],
									r = e[1],
									...
									a = i * i + r * r + n * n + s * s,
									o = a ? 1 / a : 0
								;((t[0] = -i * o), (t[1] = -r * o), (t[2] = -n * o), (t[3] = s * o))
							})(this._target, t),
							this.onChange(),
							this
						)
...
function K(t, e) {
	var i = e[0],
		...
		u = e[9],
		l = e[10]
	return ((t[0] = Math.hypot(i, r, n)), (t[1] = Math.hypot(s, a, o)), (t[2] = Math.hypot(h, u, l)), t)
}
var $,
	J =
		(($ = [1, 1, 1]),
...
var it = (function (t) {
	function r() {
		...
		return (i(this, r), u((t = e(this, r, [n, s, a, o, h, l, c, f, d, v, g, p, m, y, x, _])), t))
	}
	return (
		o(r, g(Array)),
		n(r, [
			...
			},
			{
				...
				value: function () {
					...
					return (
						(t = this),
						(i = (e =
							arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this)[0]),
						(r = e[1]),
						(n = e[2]),
						(s = e[3]),
						(a = e[4]),
			...
			},
			{
				key: 'compose',
				value: function (t, e, i) {
					var r, n, s, a, o, h, u, l, c, f, d, v, g, p, m, y, x, _, b, E, w, k, M
					return (
						(n = e),
						(s = i),
						(a = this),
	...
	nt = (function (t) {
		function r() {
			var t,
				...
				s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : n,
				a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : n,
				o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 'YXZ'
			;(i(this, r), ((t = e(this, r, [n, s, a])).order = o), (t.onChange = function () {}), (t._target = t))
			var h = ['0', '1', '2']
			return u(
				t,
				new Proxy(t, {
		...
		return (
			...
			n(r, [
				...
				},
				{
					...
					value: function () {
						this.frustum ||
							(this.frustum = [new R(), new R(), new R(), new R(), new R(), new R()])
				...
				},
				{
					...
					value: function (t) {
						var e =
							arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : t.worldMatrix
...
var wt = Object.freeze({ __proto__: null, hexToRGB: _t, numberToRGB: bt, parseColor: Et }),
	kt = (function (t) {
		function r(t) {
			var n
			return (
	...
	!(function (t, e, i) {
		...
		function l(u, l, d) {
			var m = [],
				...
				x = new c(m),
				_ = function () {
					for (var t = x.g(6), e = a, i = 0; t < o; ) ((t = (t + i) * n), (e *= n), (i = x.g(1)))
					for (; t >= h; ) ((t /= 2), (e /= 2), (i >>>= 1))
					return (t + i) / e
				}
			return (
		...
		function c(t) {
			var e,
				...
				o = (r.S = [])
			for (i || (t = [i++]); s < n; ) o[s] = s++
			for (s = 0; s < n; s++) ((o[s] = o[(a = u & (a + t[s % i] + (e = o[s])))]), (o[a] = e))
			;(r.g = function (t) {
...
var Pt = (function () {
	...
	Nt = {
		'ambient-light': { st_scale: 1, curl_scale: 5, brightness: 0.2, darkness: 0 },
		'abstract-floating-colors': { st_scale: 5, curl_scale: 0.5, brightness: 1.2, darkness: 0 },
		...
		return (
			...
			n(r, [
				...
				},
				{
					key: '_resetColors',
					value: function () {
						;((this.rttProgram.uniforms.u_color_0.value = new kt(this.palette[0])),
							(this.rttProgram.uniforms.u_color_1.value = new kt(this.palette[1])),
							(this.rttProgram.uniforms.u_color_2.value = new kt(this.palette[2])),
							(this.rttProgram.uniforms.u_color_3.value = new kt(this.palette[3])),
							(this.rttProgram.uniforms.u_color_4.value = new kt(this.palette[4])),
							(this.rttProgram.uniforms.u_color_5.value = new kt(this.palette[5])))
					}
				},
				{
					key: '_animate',
